...
<head>
	...
	<link href="<c:url value="resources/assets/plugins/bootstrap/css/bootstrap-responsive.min.css"/>" rel="stylesheet" type="text/css"/>
	<link href="<c:url value="resources/assets/plugins/font-awesome/css/font-awesome.min.css"/>" rel="stylesheet" type="text/css"/>
	<link href="<c:url value="resources/assets/css/style-metro.css"/>" rel="stylesheet" type="text/css"/>
...
<body class="login">
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">
		2015 &copy; <a href="http://www.justukfreebies.co.uk/">NAVA DIGANTHA TRUST</a> Login Form
	</div>
	<!-- END COPYRIGHT -->
	<!-- BEGIN JAVASCRIPTS(Load javascripts at bottom, this will reduce page load time) -->
	<!-- BEGIN CORE PLUGINS -->   <script src="<c:url value="resources/assets/plugins/jquery-1.10.1.min.js"/>" type="text/javascript"></script>
